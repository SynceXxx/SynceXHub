...
-- SynceHub Home Tab - Professional Dashboard Style
...
local themeGroup = home:Group({})

-- Get current theme
local currentTheme = Window:GetTheme() or "Sky"

themeGroup:Paragraph({
    Title = "Current Theme: " .. currentTheme,
    Desc = "Customize your UI appearance with beautiful themes. Changes apply instantly!",
})

home:Space()

-- Main Theme Dropdown with ALL available themes
themeGroup:Dropdown({
    Title = "Select Theme",
    Desc = "Choose from 15 available themes",
    Values = {
        "Dark",         -- Pure dark
        "Light",        -- Bright mode
        "Rose",         -- Pink aesthetic
        ...
        "Red",          -- Bold red
        "Indigo",       -- Blue-purple
        "Sky",          -- Default blue (current default)
        "Violet",       -- Purple
        "Amber",        -- Orange
        "Emerald",      -- Green
        "Midnight",     -- Dark blue
        "Crimson",      -- Deep red
        "MonokaiPro",   -- Developer theme
...
-- Quick Theme Buttons (Popular themes only)
home:Section({
    Title = "Quick Access Themes",
    TextSize = 16,
    TextTransparency = 0.3,
})

local quickThemes = home:Group({})
...
quickThemes:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({ 
            Title = "Dark Mode", 
            Content = "Perfect for night gaming!", 
            Duration = 2, 
            Icon = "moon" 
        })
    end
...
quickThemes:Button({
    Title = "Rose",
    Icon = "heart",
    Color = Color3.fromHex("#be185d"),
    Callback = function()
        Window:SetTheme("Rose")
        WindUI:Notify({ 
            Title = "Rose Theme", 
            Content = "Beautiful pink aesthetic!", 
            Duration = 2, 
            Icon = "heart" 
        })
    end
...
quickThemes:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({ 
            Title = "Rainbow Theme", 
            Content = "Colorful gradient magic!", 
            Duration = 2, 
            Icon = "sparkles" 
        })
    end
...
quickThemes:Button({
    Title = "Monokai Pro",
    Icon = "code",
    Color = Color3.fromHex("#fc9867"),
    Callback = function()
        Window:SetTheme("MonokaiPro")
        WindUI:Notify({ 
            Title = "Monokai Pro", 
            Content = "Developer favorite!", 
            Duration = 2, 
            Icon = "code" 
        })
    end
...
home:Paragraph({
    Title = "Theme Guide",
    Desc = "• Dark/Light - Classic modes\n• Sky - Default blue (recommended)\n• Rose/CottonCandy - Pink aesthetic\n• Plant/Emerald - Nature green\n• Midnight - Deep blue\n• Rainbow - Multi-color gradient\n• MonokaiPro - Developer style",
})
...
home:Paragraph({
    Title = "Version Beta - 13 Dec 2025",
    Desc = "[+] Initial Beta Release\n[+] Added Player tab with full features\n[+] Added Teleport & Tools tab\n[+] Improved config system\n[+] Better error handling\n[~] Fixed all bugs and syntax errors",
})

home:Paragraph({
    Title = "Player Features",
    Desc = "[+] WalkSpeed & JumpPower sliders\n[+] Infinite Jump toggle\n[+] No Clip mode\n[+] Fly Mode with WASD controls\n[+] Freeze Player (Anti-Push)\n[+] Player ESP with distance\n[+] Reset Character in place",
})

home:Paragraph({
    Title = "Tools & Utilities",
    Desc = "[+] Infinite Zoom Out\n[+] Disable 3D Rendering (Performance Mode)\n[+] FPS Ultra Boost\n[+] Server Management (Rejoin, Hop, Join by ID)\n[+] Cinematic Free Cam\n[+] Hide All UI (Clean Mode)",
})

home:Paragraph({
    Title = "Configuration",
    Desc = "[+] Advanced Config Manager\n[+] Auto Save & Load system\n[+] Multiple config support\n[+] Smart config loader\n[~] Improved config file structure",
})
...
-- Footer
home:Section({
    Title = "SynceHub v1.0 Beta | Made by SynceHub",
    TextSize = 13,
