...
-- ========================================
-- SYNCE CATALOG - MULTI CATEGORY (PART 4A/5)
-- Emotes + Clothing System - FIXED CARD PARENT
-- ========================================
...
-- DECLARE scroll GLOBALLY so createCard can access it
_G.SYNCE_SCROLL = nil

-- FIXED: createCard akan ambil scroll dari _G
        ...
        actionBtn.MouseButton1Click:Connect(function()
            ...
            local success = pcall(function()
                ...
                if currentCat.AssetType == 11 then
                    humanoidDesc.Shirt = thumbId
                -- Pants
                elseif currentCat.AssetType == 12 then
                    humanoidDesc.Pants = thumbId
                -- T-Shirts
                elseif currentCat.AssetType == 2 then
                    humanoidDesc.GraphicTShirt = thumbId
                -- Faces
                elseif currentCat.AssetType == 18 then
                    humanoidDesc.Face = thumbId
                ...
                elseif currentCat.AssetType == 8 or currentCat.AssetType == 41 or 
                    ...
                    -- Add to accessories
                    local accessoryAdded = false
                    for i, accId in ipairs(humanoidDesc.AccessoryBlob) do
                        if accId == thumbId then
                            accessoryAdded = true
                            break
                        end
                    end
                    if not accessoryAdded then
                        table.insert(humanoidDesc.AccessoryBlob, thumbId)
                    end
                end
    ...
    saveBtn.MouseButton1Click:Connect(function()
        ...
        if not alreadySaved then
            ...
            table.insert(savedEmotes, {
                ...
                AnimationId = currentCat.AssetType == 61 and ("rbxassetid://" .. GetRealId(thumbId)) or nil,
...
-- ========================================
-- SYNCE CATALOG - MULTI CATEGORY (PART 4B/5 - FINAL)
-- FIXED: Scroll Declaration & Card Parent
-- ========================================
...
-- ========================================
-- SHOW PAGE FUNCTION - FIXED
-- ========================================

local function showPage()
    print("[DEBUG] ===== SHOWPAGE START =====")
    print("[DEBUG] Category:", getCurrentCategory().Name)
    print("[DEBUG] Scroll exists:", scroll ~= nil)
    print("[DEBUG] Scroll parent:", scroll.Parent and scroll.Parent.Name or "none")
    ...
    print("[DEBUG] Cards in scroll:", #scroll:GetChildren() - 2) -- -2 for layout and emptyLabel
    ...
    useBtn.MouseButton1Click:Connect(function()
        local success = pcall(function()
            ...
            if item.AssetType == 11 then
                humanoidDesc.Shirt = item.Id
            elseif item.AssetType == 12 then
                humanoidDesc.Pants = item.Id
            elseif item.AssetType == 2 then
                humanoidDesc.GraphicTShirt = item.Id
            elseif item.AssetType == 18 then
                humanoidDesc.Face = item.Id
            else
                table.insert(humanoidDesc.AccessoryBlob, item.Id)
            end
...
print("🛍️ Press 'G' to toggle | Categories available!")
