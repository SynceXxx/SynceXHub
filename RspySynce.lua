...
-- ============================================
-- RemoteSpy v5 - FIXED VERSION
-- Part 5: Settings Window & Components
-- ============================================

-- Settings Window
local settingsWindow = Instance.new("Frame")
settingsWindow.Name = "SettingsWindow"
settingsWindow.Size = UDim2.new(0, isMobile and 320 or 380, 0, isMobile and 400 or 450)
settingsWindow.Position = UDim2.new(0.5, isMobile and -160 or -190, 0.5, isMobile and -200 or -225)
...
local settingsTitleFrame = Instance.new("Frame")
settingsTitleFrame.Size = UDim2.new(1, -50, 1, 0)
settingsTitleFrame.Position = UDim2.new(0, 15, 0, 0)
settingsTitleFrame.BackgroundTransparency = 1
settingsTitleFrame.Parent = settingsTitleBar

local settingsIcon = createIcon(settingsTitleFrame, ICONS.Settings,
    UDim2.new(0, 24, 0, 24),
    UDim2.new(0, 0, 0.5, -12))

local settingsTitleLabel = Instance.new("TextLabel")
settingsTitleLabel.Size = UDim2.new(1, -30, 1, 0)
settingsTitleLabel.Position = UDim2.new(0, 30, 0, 0)
...
settingsTitleLabel.TextSize = isMobile and 18 or 20
settingsTitleLabel.TextXAlignment = Enum.TextXAlignment.Left
settingsTitleLabel.Parent = settingsTitleFrame
