...
-- ============================================================
    ...
    -- ============================================================
    local fishSettings = fishing:Section({
        Title = "Fish Settings",
        Icon = "settings",
        TextSize = 19,
    })
    ...
    -- LEADERBOARD SECTION
    -- ============================================================
    local leaderboard = fishing:Section({
        Title = "Leaderboard",
        Icon = "trophy",
        TextSize = 19,
    })

    -- Add Catch Count Button (x1000)
    leaderboard:Button({
        Title = "Add Catch Count (x1000)",
        Desc = "Increase your catch count by 1000 in leaderboard",
        Icon = "plus-circle",
        ...
        Callback = function()
            local success, err = pcall(function()
                ...
                WindUI:Notify({
                    Title = "Catch Count Added!",
                    Content = "+1000 catches to leaderboard",
                    Duration = 3,
                    Icon = "check",
                })
            end)
    ...
    -- Custom Amount Input
    local customCatchAmount = 1000

    leaderboard:Input({
        Title = "Custom Catch Amount",
        Desc = "Enter custom amount (default: 1000)",
        Value = "1000",
        ...
        Callback = function(text)
            ...
            if amount and amount > 0 then
                customCatchAmount = amount
                WindUI:Notify({
                    Title = "Amount Set",
                    Content = string.format("%d catches", amount),
                    Duration = 2,
                    Icon = "check",
                })
            else
    ...
    leaderboard:Button({
        Title = "Add Custom Catch Count",
        Desc = "Add catches with your custom amount",
        Icon = "plus",
        Callback = function()
            local success, err = pcall(function()
                for i = 1, customCatchAmount do
                    game:GetService("ReplicatedStorage"):WaitForChild("FishingCatchSuccess"):FireServer()
                end
                
                WindUI:Notify({
                    Title = "Catch Count Added!",
                    Content = string.format("+%d catches to leaderboard", customCatchAmount),
                    Duration = 3,
                    Icon = "check",
                })
            end)
    ...
    info:Paragraph({
        Title = "How to Use",
        Desc = "Select fish type, choose rarity, set weight, then click Catch Fish button.",
    })
