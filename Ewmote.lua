...
-- ========================================
-- GAZE CATALOG - MULTI CATEGORY (PART 2/5)
...
-- ========================================
-- GAZE CATALOG - MULTI CATEGORY (PART 4A/5)
-- Emotes + Clothing System - ULTIMATE VERSION
-- ========================================
...
-- Category definitions with asset types
local CATEGORIES = {
...
local CURRENT_CATEGORY_INDEX = 1 -- Default: Emotes
...
-- ========================================
-- API FETCH WITH CATEGORY SUPPORT
-- ========================================
...
-- ========================================
-- SMART CARD CREATOR (ADAPTS TO CATEGORY)
-- ========================================
    ...
    elseif currentCat.CanEquip then
        ...
        actionBtn.MouseButton1Click:Connect(function()
            ...
            pcall(function()
                ...
                if currentCat.AssetType == 11 then -- Shirt
                    humanoidDesc.Shirt = thumbId
                elseif currentCat.AssetType == 12 then -- Pants
                    humanoidDesc.Pants = thumbId
                elseif currentCat.AssetType == 18 then -- Face
                    humanoidDesc.Face = thumbId
                elseif currentCat.AssetType == 8 or currentCat.AssetType >= 41 then -- Accessories
...
-- ========================================
-- GAZE CATALOG - MULTI CATEGORY (PART 4B/5 - FINAL)
-- Category Dropdown Logic + Complete System
-- ========================================
...
local function showPage()
    print("[DEBUG] showPage - Category:", getCurrentCategory().Name)
...
print("[INIT] Loading initial catalog...")
doNewSearch("")
...
print("✨ Gaze Catalog ULTIMATE - Successfully Loaded!")
print("🛍️ Press 'G' or click button to toggle")
print("📦 Categories: Emotes, Hats, Shirts, Pants, Faces & More!")

-- END - ULTIMATE VERSION COMPLETE! 🎉