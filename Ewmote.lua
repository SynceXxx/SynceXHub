...
local savedEmotes = {}
local SAVE_FILE = "SynceEmotes_NewNEWN3WSaved.json"
...
local function createCard(item, scrollParent)
    ...
    elseif currentCat.CanEquip then
        ...
        actionBtn.MouseButton1Click:Connect(function()
            ...
            pcall(function()
                ...
                elseif currentCat.AssetType == 8 or currentCat.AssetType >= 41 then
    ...
    print("[DEBUG] Card created and parented to scroll")
    return card
end
