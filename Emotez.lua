...
-- Modern Dark Theme - FIXED SIZE & SHADOW
-- ========================================
...
-- FIXED: Scale factor lebih besar
function scale(axis, value)
    local isMobile = UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled
    local baseWidth, baseHeight = 1920, 1080
    local scaleFactor = isMobile and 2.5 or 2 -- Diperbesar dari 1.5 jadi 2
...
-- ========================================
-- MAIN GUI CONTAINER (FIXED SIZE & SHADOW)
-- ========================================
...
mainContainer.ClipsDescendants = false -- Changed to false agar shadow terlihat

createCorner(mainContainer, 20) -- Lebih rounded
createStroke(mainContainer, Color3.fromRGB(70, 70, 85), 2)

-- FIXED: Shadow yang lebih halus dengan rounded corners
...
createCorner(shadowFrame, 25) -- Rounded shadow
