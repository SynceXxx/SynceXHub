...
function TabContent.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    ...
    -- ============================================================
    -- ANIMATION TAB (NEW ADVANCED SYSTEM)
    -- ============================================================
    ...
    if not LocalPlayer.Character or LocalPlayer.Character:WaitForChild("Humanoid").RigType ~= Enum.HumanoidRigType.R15 then
        ...
        return -- Stop tab creation if R6
    end
    ...
    animation:Paragraph({
        ...
        Desc = "Apply preset packs, custom IDs per movement type, or play emotes on demand. Your settings persist across respawns!",
    })
    ...
    animation:Paragraph({
        ...
        Desc = "Enter animation IDs for specific movement types. Leave blank to keep current animation.",
    })
    ...
    animation:Paragraph({
        Title = "Play Emotes",
        Desc = "Enter any emote/dance animation ID and play it. Stops when you move.",
    })
