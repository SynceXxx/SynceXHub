-- ========================================
-- GAZE EMOTES - REDESIGNED UI (PART 1/4)
...
createStroke(titleIcon, Color3.fromRGB(120, 100, 220), 2)
...
createStroke(catalogTabBtn, Color3.fromRGB(100, 80, 200), 2)

local catalogGlow = Instance.new("UIGradient")
catalogGlow.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(255, 255, 255))
catalogGlow.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.7),
    NumberSequenceKeypoint.new(1, 0.9)
}
catalogGlow.Parent = catalogTabBtn
...
createStroke(savedTabBtn, Color3.fromRGB(60, 60, 70), 1)
...
local dividerGlow = createGradient(divider, ColorSequence.new{
...
searchContainer.Size = UDim2.new(0.55, 0, 0, scale("Y", 36))
...
createStroke(searchContainer, Color3.fromRGB(60, 60, 75), 1)
...
refreshBtn.Size = UDim2.new(0.2, -scale("X", 4), 0, scale("Y", 36))
refreshBtn.Position = UDim2.new(0.57, scale("X", 2), 0, 0)
...
createStroke(refreshBtn, Color3.fromRGB(60, 140, 240), 2)

addHoverEffect(refreshBtn, Color3.fromRGB(60, 140, 240), Color3.fromRGB(40, 120, 220))

-- Sort Button
local sortBtn = Instance.new("TextButton")
sortBtn.Size = UDim2.new(0.23, -scale("X", 6), 0, scale("Y", 36))
sortBtn.Position = UDim2.new(0.77, scale("X", 4), 0, 0)
...
createStroke(sortBtn, Color3.fromRGB(80, 70, 140), 2)
...
createStroke(savedSearchContainer, Color3.fromRGB(60, 60, 75), 1)
...
-- ========================================
-- GAZE EMOTES - REDESIGNED UI (PART 3/4)
-- Sliders, Toggles, and Settings Controls
-- ========================================
...
local function createSlider(name, min, max, default)
    ...
    createGradient(container, ColorSequence.new{
    ...
    createStroke(sliderBar, Color3.fromRGB(60, 60, 75), 1)
    ...
    local fillGradient = createGradient(sliderFill, ColorSequence.new{
    ...
    createStroke(thumb, Color3.fromRGB(80, 140, 255), 3)

    local thumbGlow = Instance.new("ImageLabel")
    thumbGlow.Size = UDim2.new(1, 10, 1, 10)
    thumbGlow.Position = UDim2.new(0.5, -5, 0.5, -5)
    thumbGlow.AnchorPoint = Vector2.new(0.5, 0.5)
    thumbGlow.BackgroundTransparency = 1
    thumbGlow.Image = "rbxasset://textures/ui/GuiImagePlaceholder.png"
    thumbGlow.ImageColor3 = Color3.fromRGB(80, 140, 255)
...
local function createToggle(name)
    ...
    createStroke(toggleTrack, Color3.fromRGB(50, 50, 65), 1)
    ...
    thumbShadow.Position = UDim2.new(0.5, -4, 0.5, -4)
    thumbShadow.AnchorPoint = Vector2.new(0.5, 0.5)
    thumbShadow.BackgroundTransparency = 1
    thumbShadow.Image = "rbxasset://textures/ui/GuiImagePlaceholder.png"
...
local function createButton(name, callback)
    ...
    container.Parent = scrollFrame
    createCorner(container, 12)
    createStroke(container, Color3.fromRGB(100, 80, 200), 2)

    createGradient(container, ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(90, 70, 190)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(70, 50, 170))
    })
    ...
    addHoverEffect(button, Color3.fromRGB(100, 80, 200), Color3.fromRGB(80, 60, 180))
...
local function createCard(item)
    ...
    createStroke(card, Color3.fromRGB(60, 60, 75), 1)
    ...
    createStroke(playBtn, Color3.fromRGB(100, 220, 140), 2)
    ...
    createStroke(saveBtn, Color3.fromRGB(100, 140, 240), 2)
    ...
    saveBtn.MouseButton1Click:Connect(function()
        ...
        if not alreadySaved then
            ...
            table.insert(savedEmotes, {
                ...
                AnimationId = "rbxassetid://" .. (GetReal(thumbId) or thumbId),
                Favorite = false
            })
            saveEmotesToData()
...
-- Scroll, Navigation, Saved Cards & Toggle Button
-- ========================================
...
createStroke(prevBtn, Color3.fromRGB(80, 80, 100), 1)
...
createStroke(nextBtn, Color3.fromRGB(80, 80, 100), 1)
...
pageBox.Text = "Page 1"
createCorner(pageBox, 10)
createStroke(pageBox, Color3.fromRGB(60, 60, 75), 1)
...
local function createSavedCard(item)
    ...
    createStroke(removeBtn, Color3.fromRGB(240, 100, 100), 2)
...
btn.Draggable = true
createCorner(btn, 16)
createStroke(btn, Color3.fromRGB(100, 80, 200), 3)
...
print("📌 Press 'G' or click the 🎭 button to toggle GUI")