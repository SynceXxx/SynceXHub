-- SynceHub tab-contents.lua - PART 1
...
-- SynceHub Home Tab - Windows 8 Metro Style
-- Ganti bagian HOME TAB di tabx-contentx.lua dengan kode ini

-- ============================================================
-- HOME TAB - WINDOWS 8 METRO STYLE
-- ============================================================
...
-- Coba ambil avatar dengan pcall untuk error handling
local avatarImage = "user-circle" -- Default icon
local getAvatarSuccess, avatarResult = pcall(function()
    return Players:GetUserThumbnailAsync(userId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size150x150)
end)

if getAvatarSuccess and avatarResult then
    avatarImage = avatarResult
end

-- Profile Info tanpa gambar dulu (karena WindUI Image ada issue)
...
-- Profile Stats dalam Group
local statsGroup = profileGroup:Group({})
...
-- Premium Status (jika ada)
local premiumStatus = Player.MembershipType == Enum.MembershipType.Premium and "Premium Member" or "Free Account"
statsGroup:Section({
    Title = premiumStatus,
    TextSize = 14,
    TextTransparency = 0.3,
...
-- Profile Buttons
local profileButtonsGroup = profileGroup:Group({})

profileButtonsGroup:Button({
    Title = "View Profile",
    Icon = "external-link",
    Justify = "Center",
    Callback = function()
...
-- ============================================================
-- METRO TILES SECTION (Statistics)
-- ============================================================
home:Section({
...
local clockFrame = home:Group({})

local clockLabel = clockFrame:Section({
    Title = "Loading...",
    TextSize = 28,
    FontWeight = Enum.FontWeight.Bold,
})

local dateLabel = clockFrame:Section({
    Title = "Loading date...",
    TextSize = 16,
    TextTransparency = 0.4,
})
...
task.spawn(function()
    while true do
        ...
        -- Update using pcall to prevent errors
        pcall(function()
            clockLabel.Title = "" .. hour .. ":" .. min .. ":" .. sec
        end)
...
-- FPS Counter Tile
local fpsGroup = home:Group({})

local fpsLabel = fpsGroup:Section({
    Title = "FPS: Calculating...",
    TextSize = 24,
    FontWeight = Enum.FontWeight.Bold,
})

local fpsDesc = fpsGroup:Section({
...
task.spawn(function()
    ...
    RunService.RenderStepped:Connect(function()
        ...
        if tick() - lastUpdate >= 1 then
            ...
            pcall(function()
                fpsLabel.Title = fpsColor .. " FPS: " .. tostring(fps)
            end)
        end
    end)
end)
...
-- Ping/MS Tile
local pingGroup = home:Group({})

local pingLabel = pingGroup:Section({
    Title = "Ping: Calculating...",
    TextSize = 24,
    FontWeight = Enum.FontWeight.Bold,
})

local pingDesc = pingGroup:Section({
...
task.spawn(function()
    while true do
        ...
        local pingColor = ""
        if ping < 100 then
            pingColor = "🟢" -- Green - Excellent
        elseif ping < 200 then
            pingColor = "🟡" -- Yellow - Good
        else
            pingColor = "🔴" -- Red - Poor
        end
        
        pcall(function()
            pingLabel.Title = pingColor .. " Ping: " .. ping .. " ms"
        end)
...
home:Paragraph({
    Title = "SynceHub Discord",
    Desc = "Join our community for updates, support, and to connect with other users!",
...
actionsGroup:Button({
    ...
    Callback = function()
        ...
        -- Server hop implementation from your original code
        task.spawn(function()
...
-- Version Info
home:Section({
    Title = "SynceHub v1.0 Beta",
    TextSize = 14,
    TextTransparency = 0.5,
})
    
    -- SynceHub tab-contents.lua - PART 2 (Player Tab)
-- SALIN PART 2 DAN TEMPEL DI BAWAH PART 1
    ...
    -- SynceHub tab-contents.lua - PART 3 (Player Other)
-- SALIN PART 3 DAN TEMPEL DI BAWAH PART 2
    ...
    -- SynceHub tab-contents.lua - PART 4 (Teleport Tab)
-- SALIN PART 4 DAN TEMPEL DI BAWAH PART 3
    ...
    -- SynceHub tab-contents.lua - PART 5 (Tools Tab - Misc)
-- SALIN PART 5 DAN TEMPEL DI BAWAH PART 4
    ...
    -- SynceHub tab-contents.lua - PART 6 (Server Management)
-- SALIN PART 6 DAN TEMPEL DI BAWAH PART 5
    ...
    -- SynceHub tab-contents.lua - PART 7 (Cinematic Tools)
-- SALIN PART 7 DAN TEMPEL DI BAWAH PART 6
    ...
    -- SynceHub tab-contents.lua - PART 8 (Configuration Tab - FINAL)
-- SALIN PART 8 DAN TEMPEL DI BAWAH PART 7 - INI PART TERAKHIR!
    ...
    WindUI:Notify({ 
        ...
        Content = "SynceHub is ready to use! 🚀", 
        Duration = 3, 
        Icon = "check" 
    })
end
