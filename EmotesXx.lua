...
-- Created by SynceHub Team - Fixed by Claude
-- ============================================================
...
-- ============================================================
-- SCREEN & SCALING SETUP (FIXED - NO DUPLICATION!)
-- ============================================================
...
local function createCard(item)
    ...
    -- Copy Link Button (FIXED - Text only)
...
local function createSavedCard(item)
    ...
    -- Favorite Button (FIXED - Use text instead of emoji)
...
toggleBtn.Image = "rbxassetid://7733799795"
