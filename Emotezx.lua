...
-- ========================================
-- SYNCE EMOTES - REDESIGNED UI (PART 2/5)
...
-- ========================================
-- HEADER & TITLE (DIPERBESAR) + CLOSE/MINIMIZE
-- ========================================
...
-- Store buttons in global for Part 5 access
_G.SynceButtons = {
    Close = closeBtn,
...
-- Sliders, Toggles - NO PREVIEW MODE
-- ========================================
...
-- ========================================
-- SYNCE EMOTES - REDESIGNED UI (PART 4/5)
-- Catalog System - NO PREVIEW MODE
-- ========================================
...
local function GetEmoteDataFromWeb()
    ...
    if not result or not result.Success then
        warn("[ERROR] Request not successful")
        return false
    end
...
-- ========================================
-- SYNCE EMOTES - REDESIGNED UI (PART 5/5 - FINAL)
-- Saved Tab & Toggle Button - NO PREVIEW
-- ========================================
...
-- ========================================
-- TOGGLE BUTTON - CUSTOM IMAGE + ANIMATIONS
-- ========================================
...
print("✨ Synce Emotes UI - Successfully Loaded!")
