...
function TabContent.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    ...
    troll:Paragraph({
        Title = "Fling & Protection Tools",
        Desc = "Tools for trolling other players or protecting yourself from trolls. Use responsibly!",
    })
    ...
    troll:Paragraph({
        Title = "How Fling Works",
        Desc = "Fling spins your character rapidly to launch nearby players. Touch other players while fling is active to send them flying!",
    })

    Reg("fling", troll:Toggle({
        Title = "Enable Fling",
        Desc = "Spin rapidly to fling nearby players",
        Value = false,
        Callback = function(state)
            local FlingSystem = _G.SynceHub.FlingSystem
            
            if state then
                FlingSystem.Toggle()
                WindUI:Notify({
                    Title = "Fling Enabled!",
                    Content = "Touch players to fling them away.",
                    Duration = 3,
                    Icon = "tornado",
                })
            else
                ...
                WindUI:Notify({
                    ...
                    Content = "Fling has been turned off.",
                    Duration = 2,
                    Icon = "x",
                })
            end
    ...
    Reg("flingpower", troll:Slider({
        ...
        Callback = function(value)
            ...
            if powerValue and powerValue >= 100 then
                _G.SynceHub.FlingSystem.SetPower(powerValue)
            end
        end,
    }))
    ...
    troll:Paragraph({
        Title = "Warning",
        Desc = "Fling may cause you to spin rapidly. Some games may kick you for using fling. Use at your own risk!",
    })
