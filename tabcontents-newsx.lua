...
function TabContent.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    ...
    -- ============================================================
-- ANIMATION TAB FIX - Replace your existing animation tab with this
-- Find and REPLACE from "-- ANIMATION TAB" until before "-- CONFIGURATION TAB"
-- ============================================================
...
do -- Start animation tab scope
    ...
    if not isR15 then
        ...
        animation:Paragraph({
            ...
            Desc = "Your character is currently R6. Please switch to R15 in Avatar settings.\n\nGo to: Roblox Avatar → Body → R15",
        })
    else
        ...
        animation:Paragraph({
            Title = "Full Animation Control",
            Desc = "Apply preset packs, custom IDs, or play emotes. Settings persist across respawns!",
        })
        ...
        local presetGroup = animation:Group({})
        
        presetGroup:Button({
            Title = "Astronaut Pack",
            Icon = "rocket",
            Callback = function()
                ...
                WindUI:Notify({
                    ...
                    Content = "Float like you're in space!",
                    Duration = 2,
                    Icon = "check",
                })
            end
        ...
        presetGroup:Button({
            ...
            Callback = function()
                ...
                WindUI:Notify({
                    ...
                    Content = "Chivalry at its finest!",
                    Duration = 2,
                    Icon = "check",
                })
            end
        ...
        -- ============================================================
        animation:Section({
            Title = "Individual Animation IDs",
            Icon = "settings",
            TextSize = 18,
            FontWeight = Enum.FontWeight.SemiBold,
        })
        ...
        animation:Paragraph({
            Title = "Customize Each Movement",
            Desc = "Enter animation IDs for specific movement types.",
        })
        
        local customGroup = animation:Group({})
        
        -- Idle (2 IDs)
        local idleId1, idleId2 = "", ""
        
        customGroup:Input({
            Title = "Idle Animation 1",
            Icon = "user",
            Placeholder = "891621366",
            Callback = function(text)
                idleId1 = text
            end
        })
        ...
        customGroup:Button({
            ...
            Icon = "check",
            Callback = function()
                if idleId1 ~= "" and idleId2 ~= "" then
                    AnimationSystem.setAnimation("Idle", {idleId1, idleId2})
                    WindUI:Notify({
                        Title = "Idle Applied",
                        Content = "Idle animations updated!",
                        Duration = 2,
                        Icon = "check",
                    })
                else
                    WindUI:Notify({
                        Title = "Missing IDs",
                        Content = "Please enter both Idle animation IDs",
                        Duration = 2,
                        Icon = "info",
                    })
                end
        ...
        customGroup:Button({
            ...
            Callback = function()
                if walkId ~= "" then
                    AnimationSystem.setAnimation("Walk", walkId)
                    WindUI:Notify({
                        Title = "Walk Applied",
                        Content = "Walk animation updated!",
                        Duration = 2,
                        Icon = "check",
                    })
                end
        ...
        customGroup:Button({
            ...
            Callback = function()
                if runId ~= "" then
                    AnimationSystem.setAnimation("Run", runId)
                    WindUI:Notify({
                        Title = "Run Applied",
                        Content = "Run animation updated!",
                        Duration = 2,
                        Icon = "check",
                    })
                end
        ...
        customGroup:Button({
            ...
            Callback = function()
                if jumpId ~= "" then
                    AnimationSystem.setAnimation("Jump", jumpId)
                    WindUI:Notify({
                        Title = "Jump Applied",
                        Content = "Jump animation updated!",
                        Duration = 2,
                        Icon = "check",
                    })
                end
        ...
        customGroup:Button({
            ...
            Callback = function()
                if fallId ~= "" then
                    AnimationSystem.setAnimation("Fall", fallId)
                    WindUI:Notify({
                        Title = "Fall Applied",
                        Content = "Fall animation updated!",
                        Duration = 2,
                        Icon = "check",
                    })
                end
        ...
        animation:Paragraph({
            Title = "Play Emotes",
            Desc = "Enter any emote/dance animation ID. Stops when you move.",
        })
        
        local emoteGroup = animation:Group({})
        
        local emoteId = ""
        
        emoteGroup:Input({
            Title = "Emote Animation ID",
            Icon = "smile",
            Placeholder = "12521009666",
            Callback = function(text)
                emoteId = text
            end
        })
        ...
        emoteGroup:Button({
            ...
            Callback = function()
                if emoteId ~= "" then
                    AnimationSystem.PlayEmote(emoteId)
                    WindUI:Notify({
                        Title = "Playing Emote",
                        Content = "Move to stop the emote",
                        Duration = 2,
                        Icon = "music",
                    })
                else
                    WindUI:Notify({
                        Title = "No Emote ID",
                        Content = "Please enter an emote animation ID",
                        Duration = 2,
                        Icon = "info",
                    })
                end
        ...
        emoteGroup:Button({
            ...
            Callback = function()
                ...
                WindUI:Notify({
                    ...
                    Content = "All playing animations stopped",
                    Duration = 2,
                    Icon = "check",
                })
            end
        ...
        local quickEmoteGroup = animation:Group({})
        
        quickEmoteGroup:Button({
            Title = "Dance 1",
            Icon = "music",
            Callback = function()
                AnimationSystem.PlayEmote("12521009666")
            end
        })
        ...
        quickEmoteGroup:Button({
            ...
            Icon = "music",
            Callback = function()
                AnimationSystem.PlayEmote("12503682430")
            end
        })
        ...
        quickEmoteGroup:Button({
            ...
            Icon = "music",
            Callback = function()
                AnimationSystem.PlayEmote("12529348749")
            end
        })
        ...
        animation:Paragraph({
            ...
            Desc = "1. Go to Roblox.com\n2. Search 'animations' in Create\n3. Open any animation page\n4. Copy the number from URL\n\nExample: roblox.com/library/891621366/\nID: 891621366",
        })
