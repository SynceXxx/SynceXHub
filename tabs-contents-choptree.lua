...
function TabContent.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    ...
    if not isChopTreeGame then
        ...
        Reg("chop_autotap", farming:Toggle({
            Title = "Auto Click Super",
            Desc = "Automatically auto tap (multi-threaded)",
            Value = false,
            Callback = function(state)
                ...
                if state then
                    ...
                    WindUI:Notify({
                        Title = "Auto Tap ON",
                        Content = "Clicker tapping activated!",
                        Duration = 2,
                        Icon = "zap",
                    })
                else
                    ...
                    WindUI:Notify({
                        Title = "Auto Tap OFF",
                        Content = "Clicker tapping stopped.",
                        Duration = 2,
                        Icon = "x",
                    })
                end
