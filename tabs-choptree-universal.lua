...
do -- Start animation tab scope
    ...
    if _G.SynceHub.ChopTree then
    pcall(function()
        local ChopTreeTabs = loadstring(game:HttpGet("https://raw.githubusercontent.com/SynceXxx/SynceXHub/refs/heads/main/tabs-choptree.lua"))()
        ChopTreeTabs.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    end)
end
