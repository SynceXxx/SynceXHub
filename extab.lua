...
function TabContent.CreateTabs(Window, Reg, WindUI, SynceHubConfig, SmartLoadConfig, BaseFolder, ElementRegistry)
    ...
    graphics:Section({
        Title = "Graphics Quality Manager",
        Icon = "settings",
        TextSize = 20,
        FontWeight = Enum.FontWeight.Bold,
    })
    ...
    graphics:Paragraph({
        ...
        Desc = "Choose the perfect balance between FPS and visual quality. Changes apply instantly!",
    })
    ...
    -- ============================================================
    local GraphicsSystem = _G.SynceHub.GraphicsSystem
    ...
    local currentPresetParagraph = graphics:Paragraph({
        Title = "Current Preset",
        Desc = "Active: " .. GraphicsSystem.State.CurrentPreset,
    })
    
    -- Low Quality Button
    graphics:Button({
        Title = "Low (Performance)",
        Desc = "Maximum FPS - Minimal graphics",
        Icon = "zap",
        Color = Color3.fromHex("#FF6B6B"),
        Callback = function()
            if GraphicsSystem.ApplyPreset("Low") then
                WindUI:Notify({
                    Title = "Graphics Applied!",
                    Content = "Low quality preset activated",
                    Duration = 2,
                    Icon = "check",
                })
                pcall(function()
                    currentPresetParagraph:Set("Active: Low")
                end)
            end
        end
    })
    ...
    -- Medium Quality Button
    graphics:Button({
        Title = "Medium (Balanced)",
        Desc = "Balance between FPS and visuals",
        Icon = "activity",
        Color = Color3.fromHex("#FFA726"),
        Callback = function()
            if GraphicsSystem.ApplyPreset("Medium") then
                WindUI:Notify({
                    Title = "Graphics Applied!",
                    Content = "Medium quality preset activated",
                    Duration = 2,
                    Icon = "check",
                })
                pcall(function()
                    currentPresetParagraph:Set("Active: Medium")
                end)
            end
        end
    })
    ...
    graphics:Button({
        Title = "High (Quality)",
        Desc = "High visual quality",
        Icon = "eye",
        Color = Color3.fromHex("#66BB6A"),
        Callback = function()
            if GraphicsSystem.ApplyPreset("High") then
                WindUI:Notify({
                    Title = "Graphics Applied!",
                    Content = "High quality preset activated",
                    Duration = 2,
                    Icon = "check",
                })
                pcall(function()
                    currentPresetParagraph:Set("Active: High")
                end)
            end
        end
    })
    ...
    -- Ultra Quality Button
    graphics:Button({
        Title = "Ultra (Max Quality)",
        Desc = "Maximum visual quality - Low FPS",
        Icon = "star",
        Color = Color3.fromHex("#AB47BC"),
        Callback = function()
            if GraphicsSystem.ApplyPreset("Ultra") then
                WindUI:Notify({
                    Title = "Graphics Applied!",
                    Content = "Ultra quality preset activated",
                    Duration = 2,
                    Icon = "check",
                })
                pcall(function()
                    currentPresetParagraph:Set("Active: Ultra")
                end)
            end
        end
    })
    ...
    -- Shadows Toggle
    Reg("shadows", graphics:Toggle({
        Title = "Global Shadows",
        Desc = "Enable/disable shadows (High performance impact)",
        Value = game:GetService("Lighting").GlobalShadows,
        Callback = function(state)
            game:GetService("Lighting").GlobalShadows = state
            WindUI:Notify({
                Title = state and "Shadows ON" or "Shadows OFF",
                Content = "Shadows " .. (state and "enabled" or "disabled"),
                Duration = 1,
    ...
    -- Brightness Slider
    Reg("brightness", graphics:Slider({
        Title = "Brightness",
    ...
    -- Fog Distance Slider
    Reg("fogdist", graphics:Slider({
        Title = "Fog Distance",
        Desc = "How far you can see (higher = better)",
        Step = 100,
        Value = {
            Min = 100,
            Max = 10000,
    ...
    -- Post Effects Toggle
    Reg("postfx", graphics:Toggle({
        Title = "Post Effects",
        Desc = "Bloom, Blur, Color Correction, etc.",
        Value = true,
        Callback = function(state)
            ...
            WindUI:Notify({
                Title = state and "Effects ON" or "Effects OFF",
                Content = "Post effects " .. (state and "enabled" or "disabled"),
                Duration = 1,
                Icon = state and "sparkles" or "x",
            })
        end
    }))
    ...
    -- FPS Counter Toggle
    Reg("fpscounter", graphics:Toggle({
        Title = "FPS Counter",
        Desc = "Show real-time FPS on screen",
        Value = false,
        Callback = function(state)
            local isEnabled = GraphicsSystem.ToggleFPSCounter()
            
            if isEnabled then
                WindUI:Notify({
                    Title = "FPS Counter ON",
                    Content = "Counter displayed on top-right",
                    Duration = 2,
                    Icon = "activity",
                })
            else
                WindUI:Notify({
                    Title = "FPS Counter OFF",
    ...
    -- FPS Cap Slider (if executor supports)
    if type(setfpscap) == "function" then
        Reg("fpscap", graphics:Slider({
            Title = "FPS Cap",
            Desc = "Limit maximum FPS",
            Step = 10,
            Value = {
                Min = 30,
                Max = 240,
        ...
        graphics:Paragraph({
            Title = "FPS Cap Not Supported",
            Desc = "Your executor doesn't support setfpscap() function",
        })
    end
    ...
    graphics:Button({
        ...
        Desc = "Restore game's default graphics settings",
        Icon = "rotate-ccw",
        Color = Color3.fromHex("#FF6B6B"),
        Callback = function()
            ...
            WindUI:Notify({
                ...
                Content = "Graphics reset to game defaults",
                Duration = 3,
                Icon = "check",
            })
            pcall(function()
                currentPresetParagraph:Set("Active: Auto")
            end)
        end
    })
    ...
    graphics:Paragraph({
        Title = "Tips",
        Desc = "• Low = Best for potato PCs\n• Medium = Balanced experience\n• High = Good for modern PCs\n• Ultra = High-end PCs only\n• Settings auto-save",
    })
    ...
    graphics:Paragraph({
        Title = "Note",
        Desc = "Some games override graphics settings. If changes don't apply, the game may be forcing specific settings.",
    })
